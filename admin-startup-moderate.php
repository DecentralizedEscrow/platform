<?php require_once('_top-admin.php'); ?>
				<section class="startupMod startupEdit col-md-12">
					<div class="announcement info">
						...
						<hr/>
						<div class="row">
							<div class="col-md-3">Создана: 10.02.2018 13:57</div>
							<div class="col-md-3">Обновлена: 12.02.2018 13:57</div>
							<div class="col-md-3">Автор: <a href="#">Ульяна Крузенштерн</a></div>
						</div><br/>
						<div class="lang">
							<h4>Язык анкеты: <b>Русский</b> <span class="label label-danger">5</span> &nbsp; <button type="button" class="btn btn-xs btn-warning noborder" onclick="$('.lang .select').slideToggle();">Анкеты на других языках и статусы</button><span class="label label-danger">1</span></h3>
							<div class="col-md-6 col-xs-12 select lang admin" style="border: 1px solid #EAEAEA; display: none;">
								<table class="table table-striped">
									...
									<tbody>
									  <tr>
										...
										<td>12.06.2018</th>
										<td>На модерации</th>
										<td><button class="btn btn-xs btn-warning noborder disabled">Просмотр</button><span class="label label-danger">5</span></th>
									  </tr>
									  <tr>
										<td>English</th>
										<td>14.06.2018</th>
										<td>На модерации</th>
										<td><button class="btn btn-xs btn-warning noborder">Просмотр</button><span class="label label-danger">1</span></th>
									  </tr>
									  <tr>
										<td>German</th>
										<td>14.06.2018</th>
										<td>Черновик</th>
										<td><button class="btn btn-xs btn-warning noborder">Просмотр</button></th>
									  </tr>
									</tbody>
								</table>
							</div>
						...
						<hr/>
						<button type="button" class="noborder btn btn-success">Одобрить анкету</button>
						<button type="button" class="noborder btn btn-warning" data-toggle="modal" data-target="#rejModal">Отклонить анкету</button>
						<button type="button" class="noborder btn btn-info pull-right">Посмотреть последнюю одобренную версию</button><!-- кнопка отображается, если таковые имеются -->
					</div>
					<div class="x_panel">
						<div class="x_title">
						...
						<div class="x_content">
							<div class="tabParent" role="tabpanel" data-example-id="togglable-tabs">
								<ul id="infoTab" class="nav nav-tabs" role="tablist">
								  <li role="presentation" class="active"><a href="#tab_content1" id="home-tab" role="tab" data-toggle="tab" aria-expanded="true">Основная информация <span class="label label-danger">2</span></a>
								  </li>
								  <li role="presentation" class=""><a href="#tab_content2" role="tab" id="tab2" data-toggle="tab" aria-expanded="false">Полное описание <span class="label label-danger">1</span></a>
								  </li>
								  <li role="presentation" class=""><a href="#tab_content3" role="tab" id="tab3" data-toggle="tab" aria-expanded="false">Медиафайлы <span class="label label-danger">1</span></a>
								  </li>
								  <li role="presentation" class=""><a href="#tab_content4" role="tab" id="tab4" data-toggle="tab" aria-expanded="false">Команда <span class="label label-danger">1</span></a>
								  </li>
								</ul>
								<div id="infoTabContent" class="tab-content">
								  <div role="tabpanel" class="main tab-pane fade active in" id="tab_content1" aria-labelledby="home-tab">
									<div class="x_panel">
									  <div class="x_content">
										...
										<div class="row">
											<div class="col-sm-6 col-xs-12 fChangedMark">
									...
									<div class="x_panel">
									  <div class="x_content">
										...
										<div class="row">
											...
											<div class="teamCard col-md-3 col-sm-4 col-xs-12 fChangedMark">
												<div>
													<div class="img"><img src="http://www.epochtimes.ru/eet-content/uploads/06/cinema/161_PV.jpg" alt=""></div>
													<div class="name">Андрей Малахов</div>
													<div class="position">Технический директор</div>
								  ...
								  <div class="btns"><button type="button" class="btn btn-warning">Сохранить</button></div>
								</div>
							</div>
						</div>
					</div>
...
<div class="modal fade in" id="delLangModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<p>Вы уверены, что хотите удалить анкету проекта на языке &laquo;English&raquo;?</p>
				<hr/>
...
<!-- окно отклонения анкеты -->
<div class="modal fade in" id="rejModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				Отклонить анкету<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">×</span><span class="sr-only">Закрыть</span></button>
			</div>
			<div class="modal-body">
				<p>Вы уверены, что хотите отклонить анкету проекта <b>&laquo;Тормозной завод им. Годара&raquo;</b> на языке <b>&laquo;English&raquo;</b>?</p>
				<textarea class="form-control" rows="2" placeholder="Введите причину отклонения"></textarea>
				<hr/>
				<p class="text-center"><button type="button" class="btn btn-danger button140">Отклонить</button><button type="button" class="btn btn-warning button140" data-dismiss="modal">Назад</button></p>
			</div>
		</div>
	</div>
</div>
