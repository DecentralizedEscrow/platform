						...
						<div class="x_title">
						  ...
						  <div class="btn-group pull-right csvRep" role="group">
								...
								<div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
									<a class="dropdown-item" href="#">Торги</a>
									<a class="dropdown-item" href="#">Токены</a>
								</div>
							</div>
						</div>
						<div class="x_content">
									...
									<div class="x_panel">
									  <div class="x_content">
										...
										<div class="row stat">
											...
											<div class="col-md-3">За последние 24 часа: <b><span class="text-success">8.3575 ETH</span></b></div>
